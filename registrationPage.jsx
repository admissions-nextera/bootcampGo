    ...
    <div style={{ background: "#0a0c12", minHeight: "100vh", color: "#e8ecf5", fontFamily: "'Lora', serif", overflowX: "hidden" }}>
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "0 24px" }}>
        ...
        <section style={{ padding: "80px 0 60px", textAlign: "center" }}>
          ...
          <h1 className="fade-up" style={{ fontFamily: "'Syne', sans-serif", fontSize: "clamp(40px, 7vw, 76px)", fontWeight: 800, lineHeight: 1.0, letterSpacing: "-0.03em", marginBottom: 24, animationDelay: "0.1s", opacity: 0, animationFillMode: "forwards" }}>
            Gopher's Forge<br/>
        ...
        <section style={{ paddingBottom: 72 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32 }}>
            <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 28, fontWeight: 800, letterSpacing: "-0.01em" }}>What You'll Build</h2>
        ...
        <section style={{ paddingBottom: 72 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32 }}>
            <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 28, fontWeight: 800, letterSpacing: "-0.01em" }}>Weekend Schedule</h2>
            <div style={{ flex: 1, height: 1, background: "#1a1e28" }} />
          </div>
        ...
        <section style={{ paddingBottom: 72 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32 }}>
            <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 28, fontWeight: 800, letterSpacing: "-0.01em" }}>Your Instructor</h2>
            <div style={{ flex: 1, height: 1, background: "#1a1e28" }} />
          </div>
        ...
        <section style={{ paddingBottom: 80 }} id="register">
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32 }}>
            <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 28, fontWeight: 800, letterSpacing: "-0.01em" }}>Claim Your Spot</h2>
            <div style={{ flex: 1, height: 1, background: "#1a1e28" }} />
          </div>
